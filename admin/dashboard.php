  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-primary border-right text-white" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush bg-primary text-white">
        ...
        <a href="<?= 'dashboard.php?module=about&page=about-page-admin' ?>" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-address-card"></i> About</a>
        <a href="<?= 'dashboard.php?module=pesanan&page=daftar-pesanan' ?>" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-layer-group"></i> Pesanan</a>
        <a href="<?= 'dashboard.php?module=user&page=daftar-user' ?>" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-layer-group"></i> Pengguna</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
